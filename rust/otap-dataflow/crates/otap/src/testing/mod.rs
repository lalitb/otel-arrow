...
/// * The process must have write permissions to the directory.
///
/// # Panics
///
/// This function will panic if:
/// * The `openssl` command cannot be found or fails to execute.
/// * The CA generation fails.
...
///
/// * `openssl` must be installed and available in the system PATH.
/// * The directory must contain `ca.crt` and `ca.key` (typically generated by [`generate_ca`]).
/// * The process must have write permissions to the directory.
///
/// # Panics
///
