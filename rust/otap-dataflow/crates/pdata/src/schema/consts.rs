...
pub const DURATION_NANO: &str = "duration_nano";
...
pub const VALUE_TYPE_TYPE: &str = "type";
pub const VALUE_TYPE_UNIT: &str = "unit";
...
pub const MAPPING_ID: &str = "mapping_id";
...
pub const ATTRIBUTE_UNIT: &str = "unit";
