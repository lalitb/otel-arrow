...
pub enum ArrowPayloadType {
    ...
    SpanLinkAttrs = 45,
    Profiles = 50,
    ProfileValueTypes = 51,
    Samples = 52,
    Stacks = 53,
    StackLocations = 54,
    ProfileLocations = 55,
    ProfileLocationLines = 56,
    ProfileFunctions = 57,
    ProfileMappings = 58,
    ProfileLinks = 59,
    ProfileAttrs = 60,
    ProfileSampleAttrs = 61,
    ProfileMappingAttrs = 62,
    ProfileLocationAttrs = 63,
}
impl ArrowPayloadType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::ProfileValueTypes => "PROFILE_VALUE_TYPES",
            Self::Samples => "SAMPLES",
            Self::Stacks => "STACKS",
            Self::StackLocations => "STACK_LOCATIONS",
            Self::ProfileLocations => "PROFILE_LOCATIONS",
            Self::ProfileLocationLines => "PROFILE_LOCATION_LINES",
            Self::ProfileFunctions => "PROFILE_FUNCTIONS",
            Self::ProfileMappings => "PROFILE_MAPPINGS",
            Self::ProfileLinks => "PROFILE_LINKS",
            Self::ProfileAttrs => "PROFILE_ATTRS",
            Self::ProfileSampleAttrs => "PROFILE_SAMPLE_ATTRS",
            Self::ProfileMappingAttrs => "PROFILE_MAPPING_ATTRS",
            Self::ProfileLocationAttrs => "PROFILE_LOCATION_ATTRS",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "PROFILE_VALUE_TYPES" => Some(Self::ProfileValueTypes),
            "SAMPLES" => Some(Self::Samples),
            "STACKS" => Some(Self::Stacks),
            "STACK_LOCATIONS" => Some(Self::StackLocations),
            "PROFILE_LOCATIONS" => Some(Self::ProfileLocations),
            "PROFILE_LOCATION_LINES" => Some(Self::ProfileLocationLines),
            "PROFILE_FUNCTIONS" => Some(Self::ProfileFunctions),
            "PROFILE_MAPPINGS" => Some(Self::ProfileMappings),
            "PROFILE_LINKS" => Some(Self::ProfileLinks),
            "PROFILE_ATTRS" => Some(Self::ProfileAttrs),
            "PROFILE_SAMPLE_ATTRS" => Some(Self::ProfileSampleAttrs),
            "PROFILE_MAPPING_ATTRS" => Some(Self::ProfileMappingAttrs),
            "PROFILE_LOCATION_ATTRS" => Some(Self::ProfileLocationAttrs),
            _ => None,
        }
    }
}
...
pub mod arrow_logs_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// ArrowLogsService is a logs-only Arrow stream.
    #[derive(Debug, Clone)]
...
pub mod arrow_metrics_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// ArrowMetricsService is a metrics-only Arrow stream.
    #[derive(Debug, Clone)]
...
/// Generated client implementations.
pub mod arrow_profiles_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct ArrowProfilesServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ArrowProfilesServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> ArrowProfilesServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ArrowProfilesServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ArrowProfilesServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/opentelemetry.proto.experimental.arrow.v1.ArrowProfilesService/ArrowProfiles",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "opentelemetry.proto.experimental.arrow.v1.ArrowProfilesService",
                        "ArrowProfiles",
                    ),
                );
            self.inner.streaming(req, path, codec).await
...
/// Generated server implementations.
pub mod arrow_profiles_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ArrowProfilesServiceServer.
    #[async_trait]
    pub trait ArrowProfilesService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the ArrowProfiles method.
        type ArrowProfilesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::BatchStatus, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn arrow_profiles(
            ...
            tonic::Response<Self::ArrowProfilesStream>,
            tonic::Status,
        >;
    }
    /// ArrowProfilesService is a profiles-only Arrow stream.
    #[derive(Debug)]
    pub struct ArrowProfilesServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> ArrowProfilesServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for ArrowProfilesServiceServer<T>
    where
        T: ArrowProfilesService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/opentelemetry.proto.experimental.arrow.v1.ArrowProfilesService/ArrowProfiles" => {
                    #[allow(non_camel_case_types)]
                    struct ArrowProfilesSvc<T: ArrowProfilesService>(pub Arc<T>);
                    impl<
                        T: ArrowProfilesService,
                    > tonic::server::StreamingService<super::BatchArrowRecords>
                    for ArrowProfilesSvc<T> {
                        type Response = super::BatchStatus;
                        type ResponseStream = T::ArrowProfilesStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ArrowProfilesService>::arrow_profiles(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ArrowProfilesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ArrowProfilesServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "opentelemetry.proto.experimental.arrow.v1.ArrowProfilesService";
    impl<T> tonic::server::NamedService for ArrowProfilesServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
