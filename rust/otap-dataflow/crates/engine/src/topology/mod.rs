...
//!
//! The controller owns discovery and placement. Consumers receive resolved
//! topology/placement metadata instead of reading host state independently.
...
/// Indicates whether discovery covered all usable CPU topology information.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum TopologyCompleteness {
    /// Discovery completed for every usable CPU visible to the process.
    Complete,
    /// Discovery produced usable data, but at least one source was degraded.
    Partial,
